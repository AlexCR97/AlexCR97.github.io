...
export const Locales = {
  ...
  aboutMeSection: {
    ...
    paragraph: {
      ...
      'es-MX': `
      Cuento con experiencia en desarrollo, mantenimiento y supervisión de aplicaciones web.<br><br>
      Me especializo en aplicaciones .NET Core + Angular, pero puedo adaptarme fácilmente a otros frameworks.<br><br>
      He trabajado en el frontend construyendo SPAs, en el backend construyendo REST APIs y microservicios, bases de datos relacionales y no relacionales, integrado bibliotecas y plugins de terceros, publicado librerías reutilizables y he escrito scripts para automatización.<br><br>
      Se manejar control de versiones con GitHub y Azure Repos y he configurado pipelines de CI/CD.<br><br>
    ...
    jobs: {
      asterias: {
        ...
        companyName: {
          ...
          'es-MX': `<a href="https://asterias.com.mx/" target="_blank">Asterias Software Solutions</a>`,
        },
        summary: {
          'en-US': `Lead of a team of developers, code reviews, development of tools (<span class="text-danger">utilities, scripts, libraries</span>) for internal usage, design and implementation of <span class="text-danger">internal software architecture</span>, <span class="text-danger">unit testing</span>, and fullstack developer in various types of web applications.`,
          'es-MX': `Líder de un equipo de desarrolladores, revisiones de código, desarrollo de herramientas (<span class="text-danger">utilidades, scripts, librerías</span>) para uso interno, diseño e implementación de <span class="text- peligro">arquitectura de software interna</span>, <span class="text-danger">pruebas unitarias</span> y desarrollador fullstack en varios tipos de aplicaciones web.`,
        },
      }, // asterias
      edwire: {
        jobTitle: {
      ...
      bdi: {
        ...
        summary: {
          ...
          'es-MX': `Desarrollo de aplicaciones web con enfásis en el uso de <span class="text-danger">servicios de Azure</span> (DevOps, Repos, Pipelines, Web Jobs, etc.)`,
        },
      }, // bdi
      lnf: {
        jobTitle: {
        ...
        summary: {
          'en-US': `Contributor in the <a href="https://portal.lnfdistributors.com/login" target="_blank">L&F Distributors Portal</a>, an <span class="text-danger">E-Commerce</span>-like platform for customers and an <span class="text-danger">Admin Panel</span> for company staff.`,
          'es-MX': `Colaborador en <a href="https://portal.lnfdistributors.com/login" target="_blank">L&F Distributors Portal</a>, una plataforma <span class="text-danger">E-Commerce</span> para clientes y un <span class="text-danger">Panel de Administración</span> para el personal de la empresa.`,
        },
      }, // bdi
    },
  }, // section
  ...
  sideProjectsSection: {
    ...
    vcp: {
      summary: {
        ...
        'es-MX': `Un <span class="text-danger">Paas</span> que ofrece servicios como cron jobs, alojamiento de bases de datos, caché, IdP, entre otros. Construido con <span class="text-danger">Angular + .NET Core + MongoDB</span>. Actualmente se encuentra en constante desarrollo, pero es el proyecto propio más ambicioso en el que he trabajado.`,
      },
    },
    cbtis15Qr: {
      summary: {
        ...
        'es-MX': `Aplicación híbrida (web/Android) que integra <span class="text-danger">registro de cuentas, inicio de sesión, generación de código qr, escáner de código qr, perfiles de usuario, rastreo gps y geocodificación</span>, construida con <span class="text-danger">Ionic + Firebase</span>.`,
      },
    },
    cbtis15Maps: {
      summary: {
        ...
        'es-MX': `Aplicación híbrida (web/Android) que integra <span class="text-danger">OpenStreetMaps, rastreo gps y enrutamiento gps</span>, construida con <span class="text-danger">Ionic</span>.`,
      },
    },
    coffeeShop: {
      summary: {
        ...
        'es-MX': `Aplicación de Android para enviar pedidos a una cafetería, construida con <span class="text-danger">Android Studio + SQLite</span>.`,
      },
    },
    puppiesMemorama: {
      summary: {
        'en-US': `A web application to play the Memorama card game... with puppies! Built with <span class="text-danger">Vue.js</span>.`,
        'es-MX': `Aplicación web para jugar al juego de cartas Memorama... ¡con perritos! Construido con <span class="text-danger">Vue.js</span>.`,
      },
    },
  }, // sideProjectsSection
  funFactsSection: {
